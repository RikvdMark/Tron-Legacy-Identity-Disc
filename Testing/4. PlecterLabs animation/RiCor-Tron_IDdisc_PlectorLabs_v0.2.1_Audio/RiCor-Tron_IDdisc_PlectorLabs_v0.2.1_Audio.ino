      ...
      {        
        ...
        case SEQUENCE_POWEROFF: /* RiCor: Stop blade animation */
         ...
         case SEQUENCE_BOOT: /* RiCor: C-ring boot animation */
           musicPlayer.startPlayingFile("track050.wav"); /* RiCor: Play disc boot sound */ // Doesn't work correctly, animation stops after second segment. 
                                                                                           // Audio plays fine though but the Arduino seizes up. 
                                                                                           // nothing else responds anymore
