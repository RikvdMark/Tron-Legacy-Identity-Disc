  ...
  // SEQUENCE_BOOT        7
    ...
    switch(i)
    {
      case 1:
        ...
        InitSequence();
        musicPlayer.startPlayingFile("track050.wav"); /* RiCor: Play disc boot sound */ // Audio was played without interfering with the animation but audio was played really slowly
        break;
      ...
      case 3:
        ...
        InitSequence();
        musicPlayer.startPlayingFile("track060.wav"); /* RiCor: Play blade sound */  // Audio was played OK, animation worked but the blade animation was slowed.
        break;
      ...
      case 2:
        ...
        InitSequence();
        musicPlayer.pausePlaying(true); /* PAUSE (STOP) ALL SOUNDS/MUSIC */
        break;
