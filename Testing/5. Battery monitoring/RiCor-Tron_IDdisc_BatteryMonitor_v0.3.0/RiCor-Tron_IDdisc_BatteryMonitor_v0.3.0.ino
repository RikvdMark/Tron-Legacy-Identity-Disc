...
void loop()
{
  ...
  /*********************************/
  if //(Vout <= LowVoltage)  /* If the battery voltage is -less than- or -equal to- the "LowVoltage" value */
  {
  ...
  if //(Vout <= CritVoltage) /* If the battery voltage is -less than- or -equal to- the "CritVoltage" value */
  {
