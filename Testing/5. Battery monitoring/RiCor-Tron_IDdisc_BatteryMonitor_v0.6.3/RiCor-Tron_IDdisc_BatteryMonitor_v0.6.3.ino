...
void loop()
{
  ...
  if (measuredvbat >= 3.30)  /* If the battery voltage is -greater than- or -equal to- the "LowVoltage" value */
  {
  ...
  if (measuredvbat >= 3.10)  /* If the battery voltage is -greater than- or -equal to- the "CritVoltage" value */
  {
