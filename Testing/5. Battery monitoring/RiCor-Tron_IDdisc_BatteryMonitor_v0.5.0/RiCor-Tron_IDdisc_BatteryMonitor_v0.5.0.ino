...
* 10k resistor from A1 to the postive (+) battery terminal
...
float Aref = 1.980; // change this to the actual Aref voltage of ---YOUR--- Arduino, or adjust to get accurate voltage reading (1.000- 1.200)
...
void loop()
{
  ...
  for (int x = 0; x < 2; x++) // 2 analogue readings and 1/2 voltage divider = no additional maths
  { 
