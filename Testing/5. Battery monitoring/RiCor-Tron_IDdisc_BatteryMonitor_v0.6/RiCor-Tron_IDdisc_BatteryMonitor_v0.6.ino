...
#define CritBattLED A0
   
/*********************************/
int LowVoltage = 3.40;  /* This value sets the desired "LOW" voltage */ 
int CritVoltage = 3.20; /* This value sets the desired "CRITICAL" voltage */ 
...
void loop()
{
  ...
  if (measuredvbat >= 3.40)  /* If the battery voltage is -greater than- or -equal to- the "LowVoltage" value */
  {
    digitalWrite(LowBattLED, LOW); /* The red LED indicating the battery voltage is LOW stays off */
  }
  ...
  if (measuredvbat >= 3.20)  /* If the battery voltage is -greater than- or -equal to- the "CritVoltage" value */
  {
    digitalWrite(CritBattLED, LOW); /* The white LED indicating the battery voltage is CRITICAL stays off */
  }
  else /* If the battery voltage is -less than- the "CritVoltage" value */
  {
    digitalWrite(CritBattLED, HIGH); /* Turn on the white LED indicating the battery voltage is CRITICAL */
